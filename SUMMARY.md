...
* [系统服务器管理](system.md)
  ...
  * [推送信息注册（旧）](system/pushRegister.md)
  * [推送信息注册（新）](system/pushRegisterNew.md)
...
* [OTA升级](ota.md)
  ...
  * [手机查询所有最新版本](ota/integrationCheck.md)
  ...
  * [客户端上报下载状态](ota/firmwaresDwlStatus.md)
  * [用户的固件包](ota/firmwareAllByAccountId.md)
* [语音](voice.md)
  * [AIUI验证服务器Token](voice/verifytoken.md)
  * [AIUI设备控制](voice/deviceControl.md)
  * [Alexa设备控制](voice/alexaControlDevice.md)
  * [Alexa smart home设备控制](voice/alexaSmartHomeDeviceControl.md)
...
* [用户](userAdmin.md)
  * [用户基本信息](userAdmin/getBaseInfo.md)
...
* [权限](permissionAdmin.md)
  ...
  * [创建权限](permissionAdmin/permissionCreate.md)
  * [修改权限](permissionAdmin/permissionUpdate.md)
  * [删除权限](permissionAdmin/permissionDelete.md)
  * [权限列表](permissionAdmin/permissionList.md)
  * [查询权限详情](permissionAdmin/permissionGet.md)
  * [指定角色的权限信息](permissionAdmin/permissionByRole.md)
* [角色](roleAdmin.md)
...
* [OTA](otaAdmin.md)
  ...
  * [产品详情](otaAdmin/productDetail.md)
  * [刷新统计信息](otaAdmin/productUpdatePermission.md)
  * [查询所有产品](otaAdmin/productAll.md)
  * [查询固件包列表](otaAdmin/firmwareQuery.md)
  * [固件包详细](otaAdmin/firmwareDetail.md)
  * [检查固件包是否存在](otaAdmin/firmwareCheckBeforCreate.md)
  * [创建固件包](otaAdmin/firmwareCreate.md)
  * [修改固件包](otaAdmin/firmwareUpdate.md)
  * [删除固件包](otaAdmin/firmwareDelete.md)
  * [获得固件包和用户组关联关系](otaAdmin/firmwareNeedPermission.md)
  * [获得产品下的固件包列表](otaAdmin/firmwareByProduct.md)
  * [获取用户组](otaAdmin/firmwareAccountScope.md)
  ...
  * [查询大版本权限](otaAdmin/fpkNeedPermission.md)
  * [获取大版本和用户组关联关系](otaAdmin/fpkDependProduct.md)
* [推送](pushAdmin.md)
  * [查询推送Task](pushAdmin/pushTaskGet.md)
